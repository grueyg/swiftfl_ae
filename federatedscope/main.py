...
from federatedscope.spec.utils.tool import save_config
...
if __name__ == '__main__':
    ...
    if init_cfg.spec.use and init_cfg.federate.process_num <= 1:
    ...
    save_config(args.cfg_file, init_cfg.outdir)
    init_cfg.freeze()
