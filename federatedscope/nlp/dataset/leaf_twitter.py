...
class LEAF_TWITTER(LEAF):
    ...
    def _to_glove_embedding(self, text):
        embedding_text = [self.glove_vectors[i] for i in text]
        text =  torch.FloatTensor(embedding_text)
    ...
    def process(self):
        ...
        for num, file in enumerate(files):
            ...
            # user_list = user_list[:self.client_num]
