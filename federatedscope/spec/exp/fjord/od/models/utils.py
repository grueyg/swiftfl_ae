...
from ..layers import ODBatchNorm2d, ODConv2d, ODLinear, ODLSTM
...
def create_lstm_layer(od, *args, **kwargs):
    """Create lstm layer.

    :param od: whether to create OD layer
    :param p_s: list of p-values
    :param args: arguments for nn.LSTM
    :param kwargs: keyword arguments for nn.LSTM
    :return: nn.LSTM or ODLSTM
    """
    if od:
        return ODLSTM(*args, **kwargs)
